...
impl Map {
    ...
    pub fn soldat_map() -> Self {
        ...
        Self {
            ...
            items: vec![
                Item { x: 640.0, y: 170.0, item_type: ItemType::RocketLauncher, respawn_time: 0, active: true },
                Item { x: 640.0, y: 420.0, item_type: ItemType::Armor100, respawn_time: 0, active: true },
                Item { x: 80.0, y: 100.0, item_type: ItemType::Railgun, respawn_time: 0, active: true },
                Item { x: 1200.0, y: 100.0, item_type: ItemType::Railgun, respawn_time: 0, active: true },
            ],
            jumppads: vec![],
            teleporters: vec![],
            lights: vec![],
