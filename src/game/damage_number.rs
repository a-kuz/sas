...
impl DamageNumber {
    pub fn new(player_id: u32, target_id: u16, x: f32, y: f32, damage: i32, target_health: i32, target_armor: i32) -> Self {
        Self {
            player_id,
            target_id,
            x,
    ...
    pub fn add_damage(&mut self, additional_damage: i32, target_health: i32, target_armor: i32, new_x: f32, new_y: f32) {
    ...
    pub fn render(&self, camera_x: f32, camera_y: f32) {
        ...
        let base_font_size = if self.damage >= 100 { 40.0 } else if self.damage >= 50 { 36.0 } else { 32.0 };
