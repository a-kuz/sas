...
use crate::game::bg_pmove::{PmoveState, PmoveCmd, pmove};
...
impl ClientPrediction {
    ...
    pub fn predict_player_movement(
        ...
        let mut last_input = PmoveCmd { move_right: 0.0, jump: false, crouch: false, haste_active: false };
        for cmd in commands {
            ...
            if result.hit_jumppad { hit_jumppad = true; }
            if result.landed { landed = true; }
