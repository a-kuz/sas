...
async fn main() {
    ...
    let model =
        MD3Model::load("q3-resources/models/weapons2/machinegun/machinegun_flash.md3").unwrap();

    let texture_bytes =
        std::fs::read("q3-resources/models/weapons2/machinegun/f_machinegun.png").unwrap();
    ...
    for i in 0..5 {
        ...
        draw_text(
            &format!("Angle: {:.0}°, Roll: {:.1}°", angle.to_degrees(), roll),
            10.0,
            30.0,
            30.0,
            WHITE,
